...
\item vowels can be soft (\textcyr{ya, e, i, \"e, yu}) or hard (\textcyr{a, \cyrerev, y, o, u}) and certain combinations with consonants are restricted. There are three classes of concerned consonants: velar (\textcyr{g, k, kh}), sibilants (\textcyr{zh, ch, sh, shsh}) and the letter \textcyr{s}.
\begin{itemize}
